...
- **Do not vendor a skill into the factory.** Copying a skill's rules into the workspace forks it: the copy stops receiving upstream fixes and starts disagreeing with the installed original, and nobody can then say which is authoritative. Reference it; never copy it.
